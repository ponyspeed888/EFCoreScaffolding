...
{
    partial void MoreBuilderCalls (EntityTypeBuilder<Supplier> builder);
...
#if MVVM
    [ObservableProperty]
    private SupplierExtProp _ExtProp;
#else
    public SupplierExtProp ExtProp { get; set; }
#endif
...
public partial class SupplierExtProp
{
