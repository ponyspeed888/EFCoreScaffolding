...
{
    partial void MoreBuilderCalls (EntityTypeBuilder<CurrentProductList> builder);
...
#if MVVM
    [ObservableProperty]
    private CurrentProductListExtProp _ExtProp;
#else
    public CurrentProductListExtProp ExtProp { get; set; }
#endif
...
public partial class CurrentProductListExtProp
{
