...
{
    partial void MoreBuilderCalls (EntityTypeBuilder<Territory> builder);
...
#if MVVM
    [ObservableProperty]
    private TerritoryExtProp _ExtProp;
#else
    public TerritoryExtProp ExtProp { get; set; }
#endif
...
public partial class TerritoryExtProp
{
