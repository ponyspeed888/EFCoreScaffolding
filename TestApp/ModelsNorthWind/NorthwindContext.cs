...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.CustomerDict).HasColumnType("json");
            //entity.Property(e => e.ExtPropDynamic).HasColumnType("nvarchar(64000)");
        ...
        modelBuilder.Entity<ExtPropDef>(entity =>
        {
            entity.HasKey(e => e.ExtPropDictId);

            entity.ToTable("ExtPropDef");

            entity.Property(e => e.ExtPropDictId).HasColumnName("ExtPropDictID");
            entity.Property(e => e.Category).HasColumnType("NVARCHAR(128)");
            entity.Property(e => e.DataType).HasColumnType("NVARCHAR(128)");
            entity.Property(e => e.KeyName).HasColumnType("NVARCHAR(128)");
            entity.Property(e => e.TableName).HasColumnType("NVARCHAR(128)");
        });
