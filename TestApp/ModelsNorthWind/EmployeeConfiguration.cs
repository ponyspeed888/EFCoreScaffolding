...
{
    partial void MoreBuilderCalls (EntityTypeBuilder<Employee> builder);
...
#if MVVM
    [ObservableProperty]
    private EmployeeExtProp _ExtProp;
#else
    public EmployeeExtProp ExtProp { get; set; }
#endif
...
public partial class EmployeeExtProp
{
